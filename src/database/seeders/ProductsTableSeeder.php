...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $seasons = DB::table('seasons')->pluck('id', 'name')->toArray();
        ...
        DB::table('product_season')->insert([
            ['product_id' => $productId, 'season_id' => $seasons['秋']],
            ['product_id' => $productId, 'season_id' => $seasons['冬']]
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $productId, 'season_id' => $seasons['春']]
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $productId, 'season_id' => $seasons['夏']]
        ]);
